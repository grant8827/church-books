...
urlpatterns = [
    ...
    path('paypal/create-order/', views_subscription.paypal_create_order, name='paypal_create_order'),
    path('paypal/capture-order/', views_subscription.paypal_capture_order, name='paypal_capture_order'),
    ...
    path("payment-portals/paypal/connect/", views.initiate_paypal_connect, name="initiate_paypal_connect"),
    path("payment-portals/paypal/callback/", views.paypal_connect_callback, name="paypal_connect_callback"),
    path("dashboard/", views.dashboard_view, name="dashboard"),
    path("donate/", views.donor_payment_portal, name="donor_payment_portal"),
    path("donation/wipay/callback/", views.wipay_callback, name="wipay_callback"),
    path("donation/stripe/success/", views.donation_stripe_success, name="donation_stripe_success"),
    path("donation/stripe/webhook/", views.donation_stripe_webhook, name="donation_stripe_webhook"),
    path("donation/paypal/capture/", views.donation_paypal_capture, name="donation_paypal_capture"),
    ...
    path("churches/<int:church_id>/admin-suspend/", views.admin_suspend_church, name="admin_suspend_church"),
