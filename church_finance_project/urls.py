...
from django.views.generic import TemplateView, RedirectView # For a simple home page
...
from church_finances.startup_health import minimal_health_check, startup_debug
...
urlpatterns = [
    ...
    path('healthz/', railway_health_check, name='railway_health_slash'), # Railway health check with slash
    path('startup/', minimal_health_check, name='startup_health'), # Minimal startup health check
