...
CSRF_TRUSTED_ORIGINS = os.environ.get('CSRF_TRUSTED_ORIGINS', 'web-production-ffeb6.up.railway.app', 'http://localhost:8000,https://localhost:8000,http://127.0.0.1:8000').split(',')
